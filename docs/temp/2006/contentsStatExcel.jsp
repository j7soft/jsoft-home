...
%><%
    ...
    sb.append("<tr style='height:25pt'><td colspan='3' style='font-family:굴림;font-size:9pt;' align='center'>");
    ...
    sb.append("    <td align='center' bgcolor='#99CCFF' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:bold;'>부서/동 명</td> \r\n");
    sb.append("    <td align='center' bgcolor='#99CCFF' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:bold;'>사용자명</td> \r\n");
    sb.append("    <td align='center' bgcolor='#99CCFF' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:bold;'>콘텐츠 작업 건수</td> \r\n");
    sb.append("</tr> \r\n");
    ...
    for (int i = 0; i < deptIDs.length; i++) {
        ...
        queryForDepart +=
            "SELECT '"+deptIDs[i]+"' AS departId, '"+deptNames[i]+"' AS departName, workerId, workerName, NVL(COUNT(*), 0) AS CNT \r\n" +
            "FROM ContentsLog \r\n" +
            "WHERE \r\n" +
            strDateCondition +
            "  workerId IN ( \r\n" +
            ...
            "  ) \r\n" +
            "GROUP BY workerid, workername \r\n" +
            "UNION ALL \r\n" +
            "SELECT '"+deptIDs[i]+"' AS departId, '"+deptNames[i]+"' AS departName, ' ' as workerId, ' ' as workerName, -1 AS CNT FROM DUAL \r\n";
    }

    for (int i = 0; i < dongIDs.length; i++) {
        queryForDepart +=
            "UNION ALL \r\n" +
            "SELECT '"+dongIDs[i]+"' AS departId, '"+dongNames[i]+"' AS departName, workerId, workerName, NVL(COUNT(*), 0) AS CNT \r\n" +
            "FROM ContentsLog \r\n" +
            "WHERE \r\n" +
            strDateCondition +
            "  workerId IN ( \r\n" +
            ...
            "GROUP BY workerid, workername \r\n" +
            "UNION ALL \r\n" +
            "SELECT '"+dongIDs[i]+"' AS departId, '"+dongNames[i]+"' AS departName, ' ' as workerId, ' ' as workerName, -1 AS CNT FROM DUAL \r\n";
    }
	...
	try {
        ...
        String curDepartId = "";
        String preDepartId = "FIRST";

        while (rs.next()) {
            curDepartId = rs.getString("departId");
            departName = rs.getString("departName");
            workerName = rs.getString("workerName");
            eachCnt = rs.getInt("cnt");

            // 이전 부서 ID 와 현재 ID 가 같으면 출력치 않고
            if (!curDepartId.equals(preDepartId)) {
                sb.append("<tr style='height:17pt'> \r\n");
                sb.append("    <td bgcolor='silver' align='left' colspan='3' valign='middle' style='padding-left:20px;font-family:굴림;font-size:9pt;font-weight:normal'>" + departName + "</td> \r\n");
                sb.append("</tr> \r\n");
            }

            preDepartId = curDepartId;

            if (eachCnt == -1) {        // 각 부서의 마지막
                departTotal = departSum;
                departSum = 0;
                sb.append("<tr style='height:17pt'> \r\n");
                sb.append("    <td style='width:120pt' bgcolor='white' align='center' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:normal'></td> \r\n");
                sb.append("    <td style='width:120pt' bgcolor='white' align='center' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:normal'>합계</td> \r\n");
                sb.append("    <td style='width:120pt' width='50%' bgcolor='white' align='center' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:normal'>" + departTotal + "</td> \r\n");
                sb.append("</tr> \r\n");
            } else {
                departSum += eachCnt;
                sb.append("<tr style='height:17pt'> \r\n");
                sb.append("    <td style='width:120pt' bgcolor='white' align='center' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:normal'></td> \r\n");
                sb.append("    <td style='width:120pt' bgcolor='white' align='center' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:normal'>" + workerName + "</td> \r\n");
                sb.append("    <td style='width:120pt' width='50%' bgcolor='white' align='center' valign='middle' style='font-family:굴림;font-size:9pt;font-weight:normal'>" + eachCnt + "</td> \r\n");
                sb.append("</tr> \r\n");
            }
        }
	} catch (Exception e) {
